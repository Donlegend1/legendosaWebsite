          ...
          <div className="col-lg-6">
            <div className="rv-8-about__txt">
              ...
              <p className="rv-8-about__descr">
                We deliver innovative software solutions tailored to your business needs. From web development to mobile applications, we have the expertise to bring your ideas to life.
              </p>
              ...
              <div className="rv-8-about__stats d-flex">
                <div className="rv-8-about-stat">
                  ...
                  <h6 className="rv-8-about-stat__name">Successful Projects</h6>
                </div>
                <div className="rv-8-about-stat">
                  <h4 className="rv-8-about-stat__number">
                    <span>
                      <NumberCounter number={150} durationToComplete={3} />
                    </span>
                    +
                  </h4>
                  <h6 className="rv-8-about-stat__name">Happy Clients</h6>
                </div>
                <div className="rv-8-about-stat">
                  <h4 className="rv-8-about-stat__number">
                    <span>
                      <NumberCounter number={50} durationToComplete={3} />
                    </span>
                    +
                  </h4>
                  <h6 className="rv-8-about-stat__name">Dedicated Developers</h6>
                </div>
              </div>
