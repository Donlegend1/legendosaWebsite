          ...
          <DivAnimateYAxis className="rv-inner-contact-info-cards">
            ...
            <div className="rv-inner-contact-info">
              ...
              <div className="rv-inner-contact-info__bottom">
                <ul className="rv-5-footer-timings">
                  <li>
                    <a href="mailto:info@Legend OSA consultants.com">info@Legend OSA consultants.com</a>
                  </li>
                  <li>
                    <a href="mailto:test@Legend OSA consultants.com">test@Legend OSA consultants.com</a>
                  </li>
                </ul>
              </div>
            </div>
